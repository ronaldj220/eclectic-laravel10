                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('kasir.purchase_request.tambah_PR') }}" class="btn btn-success">
                                    <i class="fa-solid fa-plus fa-flip"></i>&nbsp;Ajukan PR
                                </a>


                                <form id="formBulan" action="{{ route('kasir.purchase_request') }}" method="GET"
                                    class="ml-auto">
                                    {{ csrf_field() }}
                                            ...
                                            @foreach ($PR as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($item->id_pr)
                                                            <a
                                                                href="{{ route('kasir.purchase_request.view_PO', ['id' => $item->id_pr]) }}">{{ $item->tipe_pr }}</a>
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    ...
                                                    @if ($item->status_approved == 'rejected' && $item->status_paid == 'rejected')
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div style="display: flex; justify-content: center;">
                                                                <a href="{{ route('kasir.purchase_request.print_PR', $item->id) }}"
