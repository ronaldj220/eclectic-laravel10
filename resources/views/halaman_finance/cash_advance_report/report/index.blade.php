                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Cari Tanggal Dokumen CAR</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('kasir.CAR.searchCAR') }}" method="POST" id="formId">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <label for="">Tanggal Awal</label>
                                        <input type="date" class="form-control @error('tgl_1') is-invalid @enderror"
                                            placeholder="" name="tgl_1" id="tgl_1">
                                        @error('tgl_1')
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="date" class="form-control @error('tgl_2') is-invalid @enderror"
                                            placeholder="" name="tgl_2" id="tgl_2">
                                        @error('tgl_2')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
    ...
    <script>
        document.getElementById('findBtn').addEventListener('click', function(event) {
            ...
            if (tanggalAwal && tanggalAkhir) {
                const messageText = `Apakah anda yakin membuat laporan CAR antara: <br> 
