                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Daftar dan Lihat CAR</h6>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('kasir.cash_advance_report.tambah_CAR') }}"
                                    class="btn btn-success">
                                    <i class="fa-solid fa-plus fa-flip"></i>&nbsp;Ajukan CAR
                                </a>


                                <form id="formBulan" action="{{ route('kasir.cash_advance_report') }}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead class="text-center">
                                        <tr>
                                            <th style="width: 1%">No Dokumen</th>
                                            <th style="width: 1%">Dasar CA</th>
                                        ...
                                        @if ($cash_advance_report)
                                            @foreach ($cash_advance_report as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('kasir.cash_advance_report.view_CA', $item->id) }}">
                                                            {{ $item->tipe_ca }}
                                                        </a>
                                                    </td>
                                                    @if ($item->status_approved == 'rejected' && $item->status_paid == 'rejected')
                                                    ...
                                                    @elseif ($item->status_approved == 'approved' && $item->status_paid == 'pending')
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div style="display: flex; justify-content: center;">
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;
                                                                <a href="{{ route('kasir.cash_advance_report.view_cash_advance_report', $item->id) }}"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Bayar">
