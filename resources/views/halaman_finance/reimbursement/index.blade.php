                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('kasir.reimbursement.tambah_RB') }}" class="btn btn-success">
                                    <i class="fa-solid fa-plus fa-flip"></i>&nbsp;Ajukan RB
                                </a>

                                <form id="formBulan" action="{{ route('kasir.reimbursement') }}" method="GET"
                                    class="ml-auto">
                                    {{ csrf_field() }}
                                ...
                                <form action="{{ route('kasir.reimbursement') }}" method="GET"
                                            ...
                                            @foreach ($reimbursement as $item)
                                                <tr>
                                                    @if ($item->status_approved == 'hold' && $item->status_paid == 'hold')
                                                        <td><a
                                                                href="{{ route('kasir.reimbursement.view_reimbursement', $item->id) }}">{{ $item->no_doku_draft }}</a>
                                                        </td>
                                                    @else
                                                        <td><a
                                                                href="{{ route('kasir.reimbursement.view_reimbursement', $item->id) }}">{{ $item->no_doku_real }}</a>
                                                        </td>
                                                    @endif
                                                    @if ($item->status_approved == 'rejected' && $item->status_paid == 'rejected')
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div style="display: flex; justify-content: center;">
                                                                <a href="{{ route('kasir.reimbursement.print_reimbursement', $item->id) }}"
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;
                                                                <a href="{{ route('kasir.reimbursement.print_bukti_reimbursement', $item->id) }}"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Print Bukti">
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;
                                                                <a href="{{ route('kasir.reimbursement.excel_reimbursement', $item->id) }}"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                    ...
                                                    @elseif ($item->status_approved == 'hold' && $item->status_paid == 'hold')
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div style="display: flex; justify-content: center;">
                                                                ...
                                                                <a href="{{ route('kasir.reimbursement.edit_RB', $item->id) }}"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Edit RB">
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;
                                                                <a href="{{ route('kasir.reimbursement.delete_RB', $item->id) }}"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                    ...
                                                    @elseif ($item->status_approved == 'approved' && $item->status_paid == 'pending')
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div style="display: flex; justify-content: center;">
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;
                                                                <a href="{{ route('kasir.reimbursement.view_reimbursement', $item->id) }}"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Bayar">
