        ...
        @foreach ($CARDetail as $item)
            <tr>
                ...
                <td
                    ...
                    {{ $item->no_bukti }}</td>
                <td
                    style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align: center; border: 10px solid black; width: 20%">
                    {{ $item->curr }}</td>
                <td
                    style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; text-align: right; border: 10px solid black; width: 20%">
                    {{ $item->nominal }}</td>
            </tr>
        @endforeach
        <tr>
