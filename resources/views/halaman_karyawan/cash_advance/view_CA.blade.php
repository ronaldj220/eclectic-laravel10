            ...
            <div id="content">
                ...
                <div class="container" style="margin-right: 60px">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.cash_advance.setujui_cash_advance', $CA->id) }}"
                                method="POST">
                                @csrf
                                <table class="table is-striped table-bordered border-dark table-sm"
                                    ...
                                    <tr>
                                        <td>{{ $no++ . '.' }}</td>
                                        <td style="text-transform:capitalize;">{{ $CA->judul_doku }}
                                            {{ date('d/m/Y', strtotime($CA->tgl_diajukan)) }}</td>
                                        <td></td>
                                        <td class="text-center">{{ $CA->curr }}</td>
                                        <td class="text-right">
                                            {{ number_format($CA->nominal, 0, ',', '.') }}</td>
                                    </tr>
