                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('karyawan.purchase_request.tambah_PR') }}" class="btn btn-success"
                                    style="margin-bottom: 10px">
                                    <i class="fa-solid fa-plus fa-flip"></i>&nbsp;Ajukan PR
                                </a>
                                <form action="{{ route('karyawan.purchase_request') }}" method="GET" id="formCari">
                                    @csrf
                                    ...
                                    <tbody>
                                        @if ($PR)
                                            @foreach ($PR as $item)
                                                <tr>
                                                    <td><a
                                                            href="{{ route('karyawan.purchase_request.view_PR', $item->id) }}">{{ $item->no_doku }}</a>
                                                    </td>
                                                    <td>{{ $item->pemohon }}</td>
                                                    ...
                                                    @if ($item->status_approved == 'rejected' && $item->status_paid == 'rejected')
                                                        ...
                                                        <td style="text-align: center;">
                                                            <a href="{{ route('karyawan.purchase_request.view_PR', $item->id) }}"
