        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <form action="{{ route('karyawan.reimbursement.update_RB', $reimbursement->id) }}" method="POST"
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform:capitalize;">
                                            ...
                                            <input type="text" name="project[]" placeholder="Isi Keperluan Project"
                                                ...
                                                type="file" name="foto[]" accept=".jpg, .png, .jpeg" class="img"
                                                style="width: 20%;" onchange="readUrl(this);"
                                                nomerData={{ $no }}>
                                            <br>
                                            <img id="blah{{ $no++ }}"
                                                src="{{ asset('/main/public/bukti_RB_admin/' . $item->bukti_reim) }}"
                                ...
                                <tr>
                                    <td style="width:25%">
                                        <div class="text-center" style="font-weight: bold">Pemohon, &nbsp;
                                            <input type="text" name="pemohon" value="{{ Auth::user()->nama }}"
                                                readonly>
        ...
        function addRB() {
            ...
            newRow.innerHTML = `
                ...
                <td style="text-transform:capitalize;">
                    ...
                    <br>
                    <img id="blah${no}" src="" alt="your image" class = 'review'>
                    <input type="date" name="tgl1[]" style="width:20%">
                    &nbsp; s/d &nbsp;
                    <input type="date" name="tgl2[]" style="width:23%">
                    <span style="margin-left: 170px">Harus JPG atau PNG</span>
