                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Daftar Biaya Project</h6>
                        </div>
                        <div class="card-body">
                            <a href="{{ route('admin.master_fee_project.tambah_fee_project') }}"
                                class="btn btn-success" style="margin-bottom: 10px"><i
                                    class="fa-solid fa-plus fa-flip"></i>&nbsp;Tambah
                                Biaya Project</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="80%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        @foreach ($FeeProject as $item)
                                            <tr>
                                                <td>{{ $no++ . '.' }}</td>
                                                <td>{{ number_format($item->nominal, 0, ',', '.') }}</td>
                                                <td class="d-flex justify-content-center">
                                                    <a href="{{ route('admin.master_fee_project.edit_fee_project', $item->id) }}"
                                                        class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="bottom" title="Edit"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{ route('admin.master_fee_project.hapus_fee_project', $item->id) }}"
