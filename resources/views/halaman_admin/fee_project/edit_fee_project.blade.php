                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Edit Biaya Project
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <form
                                        action="{{ route('admin.master_fee_project.update_fee_project', $project->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Biaya Project</label>
                                            <input type="number" class="form-control" id="exampleInputPassword1"
                                                name="nominal" value="{{ $project->nominal }}">
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="{{ route('admin.master_fee_project') }}"
