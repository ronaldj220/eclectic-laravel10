                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Accounting</h6>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('admin.accounting.simpan_accounting') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="{{ route('admin.accounting') }}" class="btn btn-danger"><i
