            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.supplier.tambah_supplier') }}" class="btn btn-success"
                                        ...
                                        @foreach ($supplier as $item)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-center">
                                                    <a href="{{ route('admin.supplier.edit_supplier', $item->id) }}"
                                                        class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="bottom" title="Edit"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{ route('admin.supplier.hapus_supplier', $item->id) }}"
