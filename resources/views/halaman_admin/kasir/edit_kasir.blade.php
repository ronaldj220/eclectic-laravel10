                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Edit Data Kasir</h6>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('admin.kasir.update_kasir', $kasir->id) }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="{{ route('admin.kasir') }}" class="btn btn-danger"><i
