...
<body>
    ...
    <div class="container" style="margin-right: 60px; ">
        ...
        <form action="{{ route('admin.reimbursement.setujui_reimbursement', $reimbursement->id) }}" method="post">
            @csrf
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form
                                            action="{{ route('admin.reimbursement.tolak_reimbursement', $reimbursement->id) }}"
                                            method="POST">
                                            @csrf
