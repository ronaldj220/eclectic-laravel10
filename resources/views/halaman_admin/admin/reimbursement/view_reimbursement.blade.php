            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ route('admin.reimbursement.setujui_reimbursement', $reimbursement->id) }}"
                                method="POST">
                                @csrf
                                            ...
                                            @foreach ($rb_detail as $item)
                                                <tr>
                                                    <td class="text-center"><img
                                                            src="{{ asset('bukti_reim_admin/' . $item->bukti_reim) }}"
                                                            alt="" width="90%">
                                                        <br>{{ $item->no_bukti }}
                                                    </td>
                                                </tr>
                                ...
                                <div class="container d-flex justify-content-center">
                                    <button class="btn btn-primary"><i
                                            class="fa-solid fa-square-check fa-beat"></i>&nbsp;Setujui</button>
                                    &nbsp; &nbsp;
