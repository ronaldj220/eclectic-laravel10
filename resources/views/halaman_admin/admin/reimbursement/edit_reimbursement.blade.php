                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Edit Reimbursement dengan
                                        no {{ $reimbursement->no_doku }}
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <form
                                        action="{{ route('admin.reimbursement.update_reimbursement', $reimbursement->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputPassword1"
                                                name="pemohon" value="{{ $reimbursement->pemohon }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Accounting</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1"
                                                name="accounting" value="{{ $reimbursement->accounting }}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Kasir</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1"
                                                name="kasir" value="{{ $reimbursement->kasir }}" readonly>
                                        </div>
                                        <div class="form-group">
