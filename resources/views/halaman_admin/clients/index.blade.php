                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Daftar Project/Client untuk
                                Support</h6>
                        </div>
                        <div class="card-body">
                            <a href="{{ route('admin.client.tambah_client') }}" class="btn btn-success"
                                        ...
                                        @foreach ($client as $item)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-center">
                                                    <a href="{{ route('admin.client.edit_client', $item->id) }}"
                                                        class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="bottom" title="Edit"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    &nbsp;&nbsp;
                                                    <a href="{{ route('admin.client.hapus_client', $item->id) }}"
