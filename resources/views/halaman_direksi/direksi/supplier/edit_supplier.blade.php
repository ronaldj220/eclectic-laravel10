                ...
                <div class="container">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">Edit Supplier</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('direksi.supplier.update_supplier', $supplier->id) }}" method="POST"
                                id="formId">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="nama_menyetujui">
                                        <option value={{ $supplier->menyetujui }}>
                                            {{ $supplier->menyetujui }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="no_rek"
                                        value="{{ $supplier->no_rekening }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Bank</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="bank"
                                        value="{{ $supplier->bank }}">
                                </div>
                                <div class="form-group">
