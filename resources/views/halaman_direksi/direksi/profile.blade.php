                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('direksi.beranda') }}">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Update Tanda Tangan
                                        Direktur</h6>
                                </div>
                                <div class="card-body">
                                    <form
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <button class="btn btn-primary mt-4"><i
                                                    class="fa-solid fa-pen-to-square fa-bounce"></i>&nbsp;Perbarui</button>
                                            <a href="{{ route('direksi.beranda') }}" class="btn btn-danger mt-4"><i
